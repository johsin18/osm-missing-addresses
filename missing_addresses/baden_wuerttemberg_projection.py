...
class BadenWuerttembergProjection:
    ...
    """
    __projection_for_Baden_Wuerttemberg: CRS
    ...
    def __init__(self):
        ...
        self.__transformer = Transformer.from_crs(self.__projection_for_Baden_Wuerttemberg, "EPSG:4326")

    def project_to_latlon(self, easting, northing):
        return self.__transformer.transform(easting, northing)
