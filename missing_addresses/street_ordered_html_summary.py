...
class StreetOrderedHtmlSummary:
    def housenumbers_order(self, info: tuple) -> tuple:
                        ...
                        for name in ordered_streets:
                            with tag('tr', name=name):
                                ...
                                with tag('td', klass='matches'):
                                    ...
                                    for (a, m) in sorted(streets[name].matches.items(), key=self.housenumbers_order):
                                ...
                                with tag('td', klass='missing'):
                                    ...
                                    for (a, m) in sorted(streets[name].missing.items(), key=self.housenumbers_order):
                                ...
                                with tag('td', klass='surplus'):
                                    ...
                                    for (a, s) in sorted(streets[name].surplus, key=self.housenumbers_order):
